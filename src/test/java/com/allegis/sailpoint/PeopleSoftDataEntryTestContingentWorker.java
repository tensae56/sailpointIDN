...
public class PeopleSoftDataEntryTestContingentWorker extends TestEnvironment {
	...
	public Object[][] TestData() {
		try {
			Object[][] excelData = new ExcelDataProvider("/excelsheets/peopleSoftDataSheet.xlsx", "peopleSoft_dataCWR")
					.getTestData();
			return excelData;
		} catch (Exception e) {
	...
	public void dataEntryPeopleSoft(String number, String firstName, String middleName, String lastName, String gender,
		...
		psDataEntry.setOrganizationalRelationshipCWR();
		...
		psDataEntry.writeTo(resource, "peopleSoft_dataCWR", "employeeID", row, PEOPLESOFTDATAENTRY);
